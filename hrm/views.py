...
def products(request):
    ...
    return render(request, 'hrm/products.html', {'products': products})
...
def customer(request, pk_test):
    ...
    return render(request, 'hrm/customer.html', context)
...
def createOrder(request, pk):
    ...
    return render(request, 'hrm/order_form.html', context)
...
def deleteOrder(request, pk):
    ...
    if request.method == "POST":
        ...
        return redirect('/')
    context = {'item': order}
    return render(request, 'hrm/delete.html', context)
